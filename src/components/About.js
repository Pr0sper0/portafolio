          ...
          <div className='about-info'>
            ...
            <div className='bio bg-light'>
              <Animated
                ...
                <p style={{ justifyContent: 'flex-start', textAlign: 'left' }}>
                  <b>Hi, my name is Valerii</b>, and I am interested in
                  partnering with you for your next project. I have a diverse
                  skill set and am confident we can find the ideal solution for
                  any task at hand. I have a proactive and open mindset, and
                  always strive to find the most efficient solution to ensure
                  mutual satisfaction.
                  <div></div>
                  <b>
                    Excellence is my driving force and I continuously work
                    towards self-improvement.
                  </b>
                  I may not have all the answers, but I am always willing to
                  listen and work with both friends and partners to achieve our
                  common goals. Together, we can navigate towards success!
                </p>
              </Animated>
            </div>
            ...
            <Animated animationInDelay='1000' animationIn='lightSpeedIn'>
              <div className='award-1'>
                ...
                <p>
                  I am Java oriented programmer with Experience in back-end as
                  well as in front-end stack.
                </p>
              </div>
            </Animated>
            <Animated animationInDelay='1250' animationIn='fadeInRight'>
              <div className='award-2'>
                ...
                <p>
                  I am a good specialist in modern web-site technologies,
      ...
      <section id='about-d' className='py-4'>
        <div className='container'>
          ...
          <p className='lead text-center'>
            Take a look at what my partners say...
          </p>
          <div className='testimonials'>
            <div>
              <p>
                Valerii is an excellent technical expert, writes in several
                programming languages. He knows how to properly motivate, listen
                and direct, working with him was a pleasure.
              </p>
              <ul>
                <li>
                  <img src={kholImg} alt='' />
            ...
            <div>
              <p>
                I appreciate meeting with Valery. He is a highly skilled
                specialist, working with him makes it easy to quickly understand
                information and build up own knowledge.
              </p>
              <ul>
                <li>
                  <img src={shovkImg} alt='' />
                </li>
            ...
            <div>
              <p>
                I hope for a productive and no less effective work in the
                future!
              </p>
              <ul>
                <li>
                  <img src={onoprImg} alt='' />
                </li>
